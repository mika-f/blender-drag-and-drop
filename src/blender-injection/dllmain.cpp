...
// search byte pattern such as following:
// XXX: LEA RCX, QWORD PTR [00007FF6754721A0H]
// XXX: MOV RDX, QWORD PTR [RDX]
// XXX: CALL 00007FF66E3E1710H
...
#define BYTE_PATTERN "E8 C3 C2 0E FF"
#define BYTE_OFFSET 17
#else
#define BYTE_PATTERN ""
